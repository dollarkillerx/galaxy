...
//	}
//
//	newSchema, err := s.initSchema(schema, table)
//	if err != nil {
...
//		return nil
//	}
//	byTable.Deltas.Old = byTable.Deltas.Def
//	byTable.Deltas.Def = newSchema.Deltas.Def
//
//	return storage.Storage.UpdateSchema(schema, table, *byTable)
//
//	//
//	//if action == "modify" {
//	//	return nil
